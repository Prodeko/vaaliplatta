    ...
    <div id="landingpageContent" className="col-10">
      <div className="mb-5">
        ...
        <ul>
          ...
          <li>Vaaliajan tapahtumat
            <ul>
              <li>Ti 7.11 klo 17.15-20:00 Vaalikokous I, AS2-sali, Maarintie 8</li>
              <li>Ma 13.11. klo 17:15-20:00 Toimariesittely, Atrium, Maarintie 8</li>
              <li>Ke 15.11. klo 17:15-20:00 Vaalipaneeli, kiltis, Maarintie 8</li>
              <li>Ke 22.11 klo 16:15-22.00 Vaalikokous II, C-sali, Otakaari 1"</li>
            </ul>
          </li>
          <li>Miten haen? - Haku foorumeilla</li>
          <li>Miten haen? - Haku vaalikokouksessa </li>
        ...
        <p>Vaalikokouksessa ehdolle voi asettua kuka tahansa killan varsinainen jäsen (maksanut killan ja AYY:n jäsenmaksun).
          ...
          virassa. <strong>Sinulla ei tarvitse olla aikaisempaa kokemusta kiltahommista - tärkeintä on motivaatio ja aito
            innostus!</strong> Sinun ei siis tarvitse olla juomanlaskija hakeaksesi IE:ksi, vastuuISO hakeaksi
          fuksikapteeniksi tai RUKin kurssijuhlan myyntitykki hakeaksesi YS-toimariksi. Myös fuksina voi hakea hallitukseen!
          Puheenjohtajaehdokkailla on tosin yleensä hyvä olla hieman kokemusta killan hallituksen tai muun vastaavan
          toiminnasta tehtäväkentän laajuuden takia.</p>
        <p>Jos kaverisi hakee virkaan, mikä sinuakin kiinnostaa, hyvä! <strong>Älä jättäydy hakemasta, vain koska toinen
          ihminen on ilmaissut kiinnostuksensa samaan virkaan.</strong> Killan ja myös hakijoiden etu on, että hakijat jo
          ennen vaaleja pääsevät syvemmin pohtimaan kiinnostavan viran sisältöä ja omia tavoitteitaan. Tervehenkinen kilpailu
          on aina hyväksi, sillä se nostaa kaikkien hakijoiden tasoa! Kannattaa siis rohkeasti hakea tehtävään, mikä sinua
        ...
        <p>Tuotantotalouden kilta Prodeko Ry:n toimintaa johtaa yhdistyksen puheenjohtaja ja hallitus. Hallituksen valitsee
          ...
          Hallituksen jäsenet istuvat myös AYY:n kokoavissa toimikunnissa, joissa pääsevät tutustumaan muiden kiltojen
          edustajiin. <a href="https://prodeko.org">Killan nettisivuilta</a> ja foorumilta löytyy hallitusviroista vielä
          enemmän tietoa!</p>
        <p>Killan kahtatoista hallituslaista täydentää joka vuosi noin 100 toimaria, yhteensä yli 170:ssä toimarivirassa.
          Toimihenkilövirat ovat luonteeltaan enemmän fokusoituneita yhteen sektoriin ja tehtävään, esimerkiksi webbitiimiin,
          ulkomaan matkoihin tai vaikka juomanlaskijoihin. Toimihenkilöillä on suuri vapaus ja vastuu omasta tehtävästään ja
          viroista voi luoda juuri itsensä näköisiä! Toimihenkilöiden ansiosta järjestyvät killan bileet, kulttuuritapahtumat,
          abimarkkinointitempaukset, it-projektit, vuosijuhlat, kiltalehden artikkelit ja monen moni muu asia. Vaihtoehtoja on
          monia ja oman mielenkiinnon mukaan voi ryhtyä yhteen tai vaikka useampaan toimarivirkaan. Myös toimariviroista
          löytyy enemmän tietoa <a href="https://prodeko.org">killan nettisivuilta</a>!</p>
        ...
        <p>Mitä kaikkea killassa on mahdollista tehdä? Mitä ovat vastuutoimarit? Mikä on toimarivaihto? Tule täyttämään
          ...
          se on suunnattu koko killalle.<strong> Kaikki vanhat toimarit:</strong> tervetuloa paikalle 18:30 alkaen kertomaan
          kiltalaisille
        ...
        <p>Oletko päättänyt hakevasi hallitukseen vai oletko vielä kahden vaiheilla? Kenties haluat kuulla ensi vuoden
          ...
          kiinnostuneiden kanssa. Treenaa siis puheesi minttiin ja tule kertomaan innostuksestasi ja motivaatiostasi
          kanssakiltalaisille! Tapahtuma järjestetään kiltahuoneella ja se on suunnattu koko killalle - hyvää treeniä etenkin
        ...
        <p>Vaalifoorumi aukeaa puhishakua varten tiistaina 24.10 ja muihin keskiviikkona 8.11! Kaikki info vaaleista,
          ...
          ensi maanantaina. Palveluun kirjaudutaan omalla Prodeko-tunnuksella. Mikäli jokin virka kiinnostaa, voi kyseisen
          viran sivulle laittaa oman kirjallisen hakemuksensa, jossa esittelee itsensä ja kertoo omista motivaatioista virkaan
          hakemiseen! Paras hakemus on juuri sinun näköisesi - tärkeintä on, että siinä käy ilmi oma kiinnostuksesi virkaan
          pituudella ei ole väliä!</p>
        <p>Puhishaun ehdolle asettuminen tapahtuu jo ennen vaalikokousta foorumeilla, jonne hakijat toimittavat kirjallisen
          hakemuksensa. Muiden virkojen osalta hakemuksen laittaminen foorumille ennen vaalikokousta ei ole välttämätöntä,
          vaan itse virallinen ehdolle asettuminen tapahtuu vasta toisessa vaalikokouksessa. Kirjallisesta hakemuksesta on
        ...
        <p>Kokouksissa puheenjohtajahakijoille on varattu esiintymisaikaa 10min ja kysymyksiin 15min per hakija, kuitenkin
          ...
          esiintymisessä. </p>
        <p>Hallitus- ja toimarihauissa esiintymiskalvojen tai muiden visuaalisten keinojen käyttäminen on kiellettyä. </p>
        ...
        <p>Jos et pysty tulemaan vaalikokoukseen, mutta haluat hakea virkoihin, se on mahdollista vaalifoorumin eli
          ...
          Hakija, joka ei ole paikalla kokouksessa, ei voi vastata vaalikokouksen esittämiin kysymyksiin. Puheenjohtaja- tai
          hallitushakija saa etukäteen lähettää esittelypuheenvuoron vaalikokoukselle tekstinä, äänitteenä tai videolla.
          Esittelyyn pätevät muuten samat säännöt, kuin paikan päällä hakijoihin.</p>
        <p>Paikan päällä oleva hakija voi vetäytyä hausta, esimerkiksi päästyään toiseen, aiemmin käsiteltyyn virkaan. Hakija,
          joka ei pääse paikalle, voi pyytää ehdolta pudottamista yhdestä roolista, jos tulee valituksi toiseen rooliin,
          ottamalla yhteyttä puheenjohtajaan (puheenjohtaja@prodeko.org / TG @pihlap). Kaikki hakijat saavat jättää
          puheenjohtajalle toiveita siitä, missä järjestyksessä virkoja käsiteltäisiin.</p>

        <p><strong>Tsemppiä hakuun ja hauskaa syksyä!</strong></p>
        <p>VaaliJännäTerkuin,<br />
          Pihla</p>
      </div>
    </div>)
}
